...
def add_folders(folders):
    ...
    for folder in folders:
        try:
            ...
            folders_table = "INSERT INTO folders (folder_id, folder_title, folder_status) VALUES (%s, %s, %s)"
...
def change_folder_status(folder_id, status):
    ...
    try:
        ...
        folders_table = "UPDATE folders SET folder_status = %s WHERE folder_id = %s"
...
def add_channel(channel):
    ...
    try:
        # Комманда SQL запроса
        channels_table = "INSERT INTO channels (folder_id, channel_id, channel_name, channel_stats, access_hash) VALUES (%s, %s, %s, %s, %s)"
...
def change_channel_status(channel_id, status):
    ...
    try:
        # Комманда SQL запроса, Изменить статус в таблице где folder_id равен полученному id
        folders_table = "UPDATE channels SET channel_stats = %s WHERE channel_id = %s"
        # назначить элементы вместо вопросов
